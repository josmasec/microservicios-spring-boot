...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter{
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		// Esta configuración es opcional solo si nuestras aplicaciones
		// cliente (Angular, JQuery ...) residen en otro dominio.
		...
		// Lo mismo -> .antMatchers("/api/productos/**", "/api/items/**", "/api/usuarios/**").hasRole("ADMIN");
	}
